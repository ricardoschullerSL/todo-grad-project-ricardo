module.exports = function(grunt) {
    ...
    grunt.initConfig({
        jshint: {
            all: ["Gruntfile.js", "server.js", "server/**/*.js", "test/**/*.js", "public/**/*.js", "!public/build/*",
                                                                                    "!public/main.js"],
            options: {
                jshintrc: true
            }
    ...
    grunt.registerTask("serve", "task to start the server", function() {
        grunt.util.spawn({
            cmd: "node",
            args: ["server"]
        });
    });
    grunt.registerTask("watch", ["execute"]);
};
